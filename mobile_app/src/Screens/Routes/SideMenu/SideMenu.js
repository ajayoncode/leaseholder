    ...
    render() {
        return (
            <Modal
                ...
                <View style={{ width: width, height: height, backgroundColor: 'rgba(0, 0, 0, 0.8)', flex: 1, flexDirection: 'row', }}>

                    <View style={{ flex: .3, height: height }}>
                    ...
                    <View style={{ width: aspectRatio > 1.6 ? 300 : 400, height: height, flex: .7 }}>
                        <Image source={Images.ic_bg} style={{ width: width, height: height, tintColor: this.props.colorTheme() }} />
                        <View style={{ width: aspectRatio > 1.6 ? 300 : 400, height: height, flex: .7, position: 'absolute', marginTop: 50 }}>
                            ...
                            <TouchableOpacity style={{ paddingLeft: 20, }} onPress={() => this.settingsOpen()}>
                                <View style={{ flexDirection: 'row', marginTop: (aspectRatio > 1.6) ? 10 : 20 }} >
                                    ...
                                    <Text style={[MenuStype.textStyle, { flex: (aspectRatio > 1.6) ? .5 : .7, }]}>{Strings.tabBarSettings}</Text>
                                    ...
                                    <View style={{ flexDirection: 'row', }}>
                                        ...
                                        <View style={{ flex: .9, }}>
                                            ...
                                            <TouchableOpacity onPress={() => this.props.hideSideMenu("personalSettingScreen")}>
                                                <View style={{ flexDirection: 'row', marginTop: (aspectRatio > 1.6) ? 10 : 20, }} >
                                                    <Image source={Images.ic_settings_white} style={MenuStype.imgStyle} />
                                                    <Text style={[MenuStype.textStyleSimple, { flex: 1 }]}>{Strings.personalSetting}</Text>
                                                </View>
                                            </TouchableOpacity>
                                            ...
                                            <TouchableOpacity onPress={() => this.props.onOpenUrl("https://www.blocksonline.co.uk/privacy-policy/")}>
                                                <View style={{ flexDirection: 'row', marginTop: (aspectRatio > 1.6) ? 10 : 20, }} >
                                                    ...
                                                    <Text style={[MenuStype.textStyleSimple, { flex: 1 }]}>{Strings.privacy_policy}</Text>
                                                </View>
                                            </TouchableOpacity>
                                            ...
                                            <TouchableOpacity onPress={() => this.props.onOpenUrl(WebConstant.termsOfService)}>
                                                <View style={{ flexDirection: 'row', marginTop: (aspectRatio > 1.6) ? 10 : 20, }} >
                                                    ...
                                                    <Text style={[MenuStype.textStyleSimple, { flex: 1 }]}>{Strings.terms}</Text>
                                                </View>
                                            </TouchableOpacity>
 ...
 */}
                            ...
                            <TouchableOpacity style={{ paddingLeft: 20 }} onPress={() => this.btnLogout()}>
                                <View style={{ flexDirection: 'row', marginTop: (aspectRatio > 1.6) ? 10 : 20, }} >
...
const MenuStype = StyleSheet.create({
    ...
    textStyleSimple: {
        fontSize: (aspectRatio > 1.6) ? 14 : 32,
        color: "#fff",
        marginLeft: (aspectRatio > 1.6) ? 10 : 20,
        justifyContent: "center",
        alignItems: 'center'
    ...
    imgStyle: {
        width: (aspectRatio > 1.6) ? 25 : 40, height: (aspectRatio > 1.6) ? 25 : 40, resizeMode: 'contain',
    },
